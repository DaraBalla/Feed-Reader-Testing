...
See https://daraballa.github.io/Feed-Reader-Testing/.

## How to run this project locally

Click "Clone in Desktop" / "Download ZIP"
After downloading the ZIP, unzip the file
Open the unziped folder
Open index.html on your browser
There should be several test results at the bottom of the screen that says how many specs and failures are there
